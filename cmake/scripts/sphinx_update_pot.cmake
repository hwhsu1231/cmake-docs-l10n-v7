...
message(STATUS "Adding 'html_theme_options' configuration to 'conf.py' file...")
...
if (NOT OLD_HTML_THEME_OPTIONS_DICT)
    ...
    remove_cmake_message_indent()
    message("")
    message("'html_theme_options' appended to ${DOCS_CONF_PY_PATH}.")
    ...
    remove_cmake_message_indent()
    message("")
    message("'html_theme_options' already defined in ${DOCS_CONF_PY_PATH}.")
